...
let ordersMock: [OrderType] = [
    ...
    OrderType(id: 4, name: "Desconto", image: "descontos"),
    OrderType(id: 5, name: "PetShop", image: "petshop"),
...
let storesMock: [StoreType] = [
    StoreType(
        ...
        location: "Rua princial do Benfica, Luanda",
        stars: 4,
        distance: 5,
        products:  [
            ProductType(id: 1, name: "Hamburger Classico", description: "Hamburger com carne com queijo, alface e tomate", image: "bacon_burger", price: 16.990),
            ProductType(id: 2, name: "Batatas Fritas", description: "Porcao de batatas fritas", image: "fries", price: 2.500),
            ProductType(id: 3, name: "Refrigerante", description: "Lata de refrigerante de 355ml", image: "soda", price: 3.000),
            ProductType(id: 4, name: "Sorvete de Baunilha", description: "Copo de sorvete de baunilha", image: "vanilla_ice_cream", price: 4.99),
            ProductType(id: 5, name: "Hambúrguer Clássico", description: "Hambúrguer de carne com queijo, alface e tomate", image: "classic_burger", price: 14.99),
        ]
    ...
    StoreType(
           ...
           products: [
               ...
               ProductType(id: 22, name: "Açaí Médio", description: "Açaí na tigela de 500ml com granola, banana e leite condensado", image: "medium_acai", price: 1.000),
               ProductType(id: 23, name: "Açaí Grande", description: "Açaí na tigela de 700ml com granola, banana, leite condensado e morangos", image: "large_acai", price: 13.990),
               ProductType(id: 24, name: "Smoothie de Morango", description: "Smoothie de morango feito com iogurte natural", image: "strawberry_smoothie", price: 6.000),
               ProductType(id: 25, name: "Smoothie de Banana e Cacau", description: "Smoothie de banana e cacau feito com iogurte natural", image: "banana_cocoa_smoothie", price: 7.000)
           ]
       ),
    StoreType(
        id: 4,
        ...
        products: [
            ...
            ProductType(id: 13, name: "Fraldinha", description: "Fraldinha grelhada servida com arroz, farofa e vinagrete", image: "fraldinha", price: 27.990),
            ProductType(id: 14, name: "Maminha", description: "Maminha grelhada servida com arroz, farofa e vinagrete", image: "maminha", price: 28.990),
            ProductType(id: 15, name: "Churrasco Misto", description: "Churrasco misto com linguiça, frango e carne bovina, servido com arroz, farofa e vinagrete", image: "mixed_grill", price: 34.990)
        ]
    ),
    StoreType(
         id: 4,
